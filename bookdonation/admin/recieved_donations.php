...
<html>
    <head>
      <title>Recieved Donations</title>
...
<div class="content container" >
    ...
    <thead class="table-header bg-info text-white">
      ...
      <tbody>
        ...
        $sql = "SELECT  `donate_id`,`status`,`delivered`, `phone`, `address`, `city`, `state`,"
                . " `zipcode`, `no_book`, `category`, `donation_date` FROM `donation` WHERE status=1 AND delivered=1";
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          data-toggle="modal" data-target="#myModal"
           <?php echo " href="; echo "javascript:void(0)"; echo "><i class='fa fa-trash' ></i>delete</a>"."</td>";
          echo"</tr>";
               }
